            ...
            <v-window v-model="step" class="mt-4">
              ...
              <div class="text-center">
                <v-window-item :value="1">
                  <v-form ref="form1">
                    <v-text-field v-model="username" label="Username" :rules="[rules.required, rules.usernameValid]"
                      clearable autofocus @keydown.enter.prevent="next" />
                  </v-form>
              ...
              <v-window-item :value="2">
                <v-form ref="form2">
                  <v-text-field v-model="firstname" label="Your first name" :rules="[rules.required]" clearable
                    autofocus />
