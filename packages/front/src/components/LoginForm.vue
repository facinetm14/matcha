  ...
  <v-card v-if="!forgotMode" max-width="420" width="100%">
    ...
    <v-card-text>
      <v-form ref="loginForm">
        <v-text-field v-model="username" label="Username" :rules="[rules.required]" clearable autofocus
          @keydown.enter.prevent="login" />
        <v-text-field v-model="password" label="Password" type="password" :rules="[rules.required]" clearable
          @keydown.enter.prevent="login" />
  ...
  <v-card v-else max-width="420" width="100%">
    ...
    <v-card-text>
      <v-form ref="forgotForm">
        <v-text-field v-model="email" label="Enter your email address" type="email" placeholder="email"
          :rules="[rules.required, rules.email]" clearable autofocus @keydown.enter.prevent="sendReset" />
