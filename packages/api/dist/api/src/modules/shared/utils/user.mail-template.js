...
exports.buildResetPasswordEmailTemplate = exports.buildUserRegisteredEmailTemplate = void 0;
const buildUserRegisteredEmailTemplate = (username, verifyLink) => {
    const template = `
    <!DOCTYPE html>
    <html lang="en">
    <head>
...
exports.buildUserRegisteredEmailTemplate = buildUserRegisteredEmailTemplate;
const buildResetPasswordEmailTemplate = (username, newPasswordLink) => {
    const template = `
    <!DOCTYPE html>
    <html lang="en">
    <head>
...
exports.buildResetPasswordEmailTemplate = buildResetPasswordEmailTemplate;
